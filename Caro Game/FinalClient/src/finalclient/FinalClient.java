...
public class FinalClient {
    ...
    public FinalClient() {
        ...
        // Add JTextField for entering server IP
        ipField = new JTextField("127.0.0.1"); // Default IP
        ipField.setBounds(10, 5, 100, 20);
        f.add(ipField);

        // Add JButton for connecting to the server
        JButton connectButton = new JButton("Connect");
        connectButton.setBounds(120, 5, 80, 20);
        f.add(connectButton);
    ...
    try {
        ...
        // Connect to the new server IP
        socket = new Socket(ipField.getText(), 1234);
